...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=simushir&box=152.323289,47.191525,151.662325,46.742372
...
-----------
  ...
  * simushir Height Map (ASTER 30m).png
  ...
  * simushir Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * simushir Height Map (SRTM3 v4.1).png
  ...
  * simushir Height Map (SRTM30 Plus).png
